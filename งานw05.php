...
<head>
    ...
    <title>6014421003-w05</title>
</head>
<body>
<?php
    echo "1.ฟังก์ชัน Round" . "<br>";
    /*  ฟังก์ชัน Round
...
<?php
  ...
  ?>
<?php
    echo "4.ฟังก์ชั่นที่เกี่ยวกับการนำค่าที่น้อยที่สุดใน array ออกมาแสดงผล" . "<br>";
...
?>
<?php
    echo "5.ฟังก์ชั่นที่เกี่ยวกับการนำค่าที่มากที่สุดใน array ออกมาแสดงผล" . "<br>";
...
?> 
<?php
    echo "ฟังก์ชั่นที่6. ฟังก์ชั่นที่เกี่ยวกับการหาค่าลอการิทึมฐาน 10" . "<br>";
    echo log10(50)."<br>";
?>
</body>
</html>